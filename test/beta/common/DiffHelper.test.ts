...
import { getDifference, mergeDiff } from "beta/common/DiffHelper";
import { DifferenceChangeType, IDifferences } from "beta/store/storage/interface/RedoUndoStack";
import { IStoreState, STORE_STATE_INSTANCE, STORE_STATE_SYSTEM } from "beta/store/storage/interface/StoreState";

describe("aitianyu-cn.node-module.tianyu-store.beta.common.DiffHelper", () => {
